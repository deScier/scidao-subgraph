...
export class Submited extends ethereum.Event {
  get params(): Submited__Params {
    return new Submited__Params(this);
  }
}

export class Submited__Params {
  _event: Submited;

  constructor(event: Submited) {
    this._event = event;
  }
...
export class SubTests extends ethereum.SmartContract {
  static bind(address: Address): SubTests {
    return new SubTests("SubTests", address);
  }
  ...
  submissionAuthor(param0: Bytes): Address {
    let result = super.call(
      "submissionAuthor",
      "submissionAuthor(bytes32):(address)",
  ...
  try_submissionAuthor(param0: Bytes): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "submissionAuthor",
      "submissionAuthor(bytes32):(address)",
      [ethereum.Value.fromFixedBytes(param0)]
